export const ADDON_ID = '@cleverb/storybook-addon-adr'
export const PANEL_ID = `${ADDON_ID}/panel`
export const MANIFEST_FILENAME = 'sb-adr-data.json'

export const PARAM_KEY = `adr`
...
export const TEST_PROVIDER_ID = 'storybook/addon-adr/test-provider'
...
export const STATUS_TYPE_ID_ADR = 'storybook/adr'
